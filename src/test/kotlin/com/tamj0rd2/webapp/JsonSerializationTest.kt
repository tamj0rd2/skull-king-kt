...
class JsonSerializationTest {
    ...
    fun `can serialize and deserialize Notifications`() {
        test<Notification>(
            ...
            """{"type":"com.tamj0rd2.webapp.Notification.BiddingCompleted","bids":{"somePlayer":1,"someOtherPlayer":2}}"""
        )
    }
    ...
    fun `can serialize and deserialize Messages`() {
        ...
        test<Message>(
            obj,
            """{"type":"com.tamj0rd2.webapp.Message.ToServer","command":{"type":"com.tamj0rd2.domain.PlayerCommand.JoinGame","actor":"freddy_first"},"id":"${obj.id}"}"""
        )
    }
